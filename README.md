...
Through comparison of different time series models(AR, ARIMA, SARIMA, Holt Winter Seasonal Method), machine learning regression models (Decision Tree, Random Forest Regressor) and neural network models (LSTM and GRU) using different performance metrics (MAE, WMAE, MSE, and RSME). The best performer would be used to predict future sales for Walmart.
